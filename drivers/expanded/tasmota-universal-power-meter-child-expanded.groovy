...
metadata {
    definition (name: "Tasmota - Universal Power Meter (Child)", namespace: "tasmota", author: "Jon Li", filename: "tasmota-universal-power-meter-child", importUrl: "https://raw.githubusercontent.com/ljfh001/Hubitat/release/drivers/expanded/tasmota-universal-power-meter-child-expanded.groovy") {
        capability "Refresh"
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal Power Meter (Child)', 'namespace': 'tasmota', 'author': 'Jon Li', 'filename': 'tasmota-universal-power-meter-child', 'importUrl': 'https://raw.githubusercontent.com/ljfh001/Hubitat/release/drivers/expanded/tasmota-universal-power-meter-child-expanded.groovy']
